...
import { inteprateGraderslistFormAction, graderslistProfileData , popDeleteDialog, InteprateGraderslistEvent } from '../dataControl/GraderslistRequestHandler';

//state management
import { useGraderslistState } from '../dataControl/GraderslistStateManager';
...
export default function GraderslistProfile({ dataIn = {}, dataOut = {} }) {
  ...
  const {
    ...
    customProfileData={},
    hostParent="GraderslistMainProfilePage",
    parentProfileItemId = "GraderslistProfileTray"
  ...
  //manage Graderslist states
  const [stateItem, stateItemSetters] = useGraderslistState(settersOverrides);
  const gradersNode = stateItem.graderslistNode
  
  // -- basic states --//
  const paramGraderslistUptoken  = stateItem.graderslistUptoken
  const graderslistActionStatus = stateItem.graderslistActionStatus
  ...
  const handleInputChange = mosyFormInputHandler(stateItemSetters.setGraderslistNode);
  
  //use route navigation system
  const router = useRouter();
  
  //manage post form
  function postGraderslistFormData(e) {
    
    MosyNotify({message: "Sending request",icon:"send"})
    
    inteprateGraderslistFormAction(e, stateItemSetters).then(response=>{
      
      setChildDataOut({
        
        actionName : response.actionName,
        dataToken : response.newToken,
        actionsSource : "postGraderslistFormData",
        setters :{
      ...
      stateItemSetters.setActiveScrollId("GraderslistProfileTray")
  ...
  useEffect(() => {
    ...
    graderslistProfileData(customQueryStr, stateItemSetters, router, customProfileData)
  ...
  return (
    ...
    <div className="p-0 col-md-12 text-center row justify-content-center m-0  " id="GraderslistProfileTray">
      {/* ================== Start Feature Section========================== ------*/}
      
      
      <div className="col-md-12 rounded text-left p-2 mb-0  bg-white ">
        <div className={` profile_container col-md-12 m-0 p-0  ${showNavigationIsle &&("pr-lg-4 pl-lg-4 m-0")}`}>
          <form onSubmit={postGraderslistFormData} encType="multipart/form-data" id="graders_profile_form">
            ...
            <h3 className="col-md-12 title_text text-left p-0 pt-3 hive_profile_title row justify-content-center m-0 ">
              ...
              <>{!showNavigationIsle && (<div className="col m-0 p-0 text-right ">
                {paramGraderslistUptoken && (
                  <DeleteButton
                  src="GraderslistMainProfilePage"
                  tableName="graders"
                  uptoken={paramGraderslistUptoken}
            ...
            <><div className="row justify-content-end m-0 p-0 col-md-12  p-3 bg-white hive_profile_navigation " id="">
              ...
              {paramGraderslistUptoken && showNavigationIsle && (
                <>
        ...
        <div className="row justify-content-center m-0 p-0 col-md-12" id="">
          ...
          <div className="col-md-12 row justify-content-center m-0  p-0">
            ...
            <section className="hive_control">
              <input type="hidden" id="graders_uptoken" name="graders_uptoken" value={paramGraderslistUptoken}/>
              <input type="hidden" id="graders_mosy_action" name="graders_mosy_action" value={graderslistActionStatus}/>
            </section>
